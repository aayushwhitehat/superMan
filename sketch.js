...
function setup() {
  ...
  block14 = new Block(340,128,100,40);
  block15 = new Block(520,260,50,100);
  block16=new Block(474,182,150,40)
...
function draw() {
  ...
  //MAM PLZZZ TELL ME HOW TO DO THAT IF MONSTER.Y >GROUND.Y IT SHOULD SHOW YOU WON PZZZZ IN WHATSAPP
  //if(monster.y>ground.y){
   // text("youwon!!",500,200);
   //}
